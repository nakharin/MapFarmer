...
import com.emcsthai.emcslibrary.Utils.AnimationUtil;

import java.lang.reflect.Field;
import java.util.List;

/**
 * Created by nakarin on 4/12/2017 AD.
 * Reference https://github.com/MiguelCatalan/MaterialSearchView
 */
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void initStyle(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a != null) {
            ...
            if (a.hasValue(R.styleable.SearchView_android_inputType)) {
                setInputType(a.getInt(R.styleable.SearchView_android_inputType, EditorInfo.TYPE_NULL));
            }
    ...
    private void initiateView() {
        LayoutInflater.from(mContext).inflate(R.layout.view_group_search, this, true);
